...
import eu.vortexgg.mmorpg.util.ParticleEffect.ParticleData;
import eu.vortexgg.mmorpg.util.ReflectionUtil.PackageType;
...
public enum ParticleEffect {
	...
	public static void initialize() throws VersionIncompatibleException {
		...
		playerConnection = ReflectionUtil.getField("EntityPlayer", PackageType.MINECRAFT_SERVER, false,
			"playerConnection");
	...
	private void initializePacket(Location center) throws PacketInstantiationException {
		...
		ReflectionUtil.setValue(packet, true, "a", EnumParticle.values()[effect.getId()]);
